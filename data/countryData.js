const countries = [ { name: 'Mexico',
  ...
  { name: 'Uzbekistan',
    ...
    { name: 'United States',
      ...
      questions: [ 'By law, only dead people can appear on this countries currency.',
    'During Prohibition this countries government started poisoning beer, which led to thousands of deaths.' ] },
